                    ...
                    <div className='row'>
                        <div className='media text-left'>
                            ...
                            <div className='media-body align-self-center'>
                                ...
                                <Modal show={openBioPopUp} onHide={() => setOpenBioPopUp(false)}>
                        ...
                        <div className='avilability ml-auto text-right'>
                            ...
                            <div className='align-self-center row d-flex mx-0 my-2'>
                                ...
                                <Modal show={openAvailability} onHide={() => setOpenAvailability(false)}>
                                    <div>Changing your Availability</div>
                                    <div>
                                        <div>
                                                ...
                                                {switchAvailability == true && (
                                                    <div>
                                                        <div className='small-size text-left opacity-8 py-2'>
                                                            When your status is set to ‘Available’, your Requestors and
                                                            You will receive browser and email notifications in order to
                                                            start your meetings.
                                                        </div>
                                                        <div className='form-group mb-0 px-0 py-3'>
                                                            ...
                                                            <div className='radio'>
                                                                <input
                                                                    ...
                                                                    value='10 minutes'
                                                                    onChange={e =>
                                                                        changeAvailabilityDuration(e.target.value)
                                                                    }
                                                                />
                                                                <label
                                                                    for='radio-1'
                            ...
                            <span className='small-size extend'>
                                Available for <span>7</span> hours <span>59</span> minutes. <a href='#'>Extend ⯆</a>
                            </span>
                        </div>
                    </div>
                </div>
